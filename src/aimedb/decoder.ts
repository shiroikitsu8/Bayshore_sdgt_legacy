...
function begin(msg: Buffer): Request.AimeRequestBase {
  const gameId = msg.toString("ascii", 0x000a, 0x000e) || 'SDGT';
  const keychipId = msg.toString("ascii", 0x0014, 0x001f) || 'A69E01A8888';
...
function readLogRequest2(msg: Buffer): Request.LogRequest2 {
  // idk what any of this stuff means yet
  // field20 and field28 appear to be an aime id but that is all.
...
readers.set(0x0013, readLogRequest2);
...
export class Decoder extends Transform {
  ...
  _transform(msg: Buffer, encoding: any, callback: any) {
