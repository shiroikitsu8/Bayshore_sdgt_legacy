-- CreateTable
CREATE TABLE "challengeModeResult" (
    "id" SERIAL NOT NULL,
    ...
    CONSTRAINT "challengeModeResult_pkey" PRIMARY KEY ("id")
);

-- AddForeignKey
ALTER TABLE "challengeModeResult" ADD CONSTRAINT "challengeModeResult_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
